...
async function askAI(prompt) {
  if (!OPENAI_API_KEY) throw new Error("OpenAI API key not set. Check your .env file.");
...
app.post("/api/keywords", async (req, res) => {
  try {
    ...
    const result = await askAI(`Generate a list of SEO keywords for: ${topic}. Return only comma-separated keywords.`);
